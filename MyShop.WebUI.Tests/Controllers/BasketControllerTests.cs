...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            Assert.AreEqual(2.00m, basketSummary.BasketTotal);
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "abc@980.com", ZipCode = "44321" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("abc@980.com","Forms"),null); 
